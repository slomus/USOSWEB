...
func (x *UserSubject) GetClassId() int32 {
	if x != nil {
		return x.ClassId
	}
	return 0
...
func (x *UserSubject) GetSubjectName() string {
	if x != nil {
...
type User struct {
	...
	AlbumNr               *int64                 `protobuf:"varint,17,opt,name=album_nr,json=albumNr,proto3,oneof" json:"album_nr,omitempty"`
	TeachingStaffId       *int64                 `protobuf:"varint,18,opt,name=teaching_staff_id,json=teachingStaffId,proto3,oneof" json:"teaching_staff_id,omitempty"`
	AdministrativeStaffId *int64                 `protobuf:"varint,19,opt,name=administrative_staff_id,json=administrativeStaffId,proto3,oneof" json:"administrative_staff_id,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *User) GetTeachingStaffId() int64 {
	if x != nil && x.TeachingStaffId != nil {
		return *x.TeachingStaffId
	}
	return 0
}

func (x *User) GetAdministrativeStaffId() int64 {
	if x != nil && x.AdministrativeStaffId != nil {
		return *x.AdministrativeStaffId
	}
	return 0
}
...
const file_auth_proto_rawDesc = "" +
	...
	"\amessage\x18\n" +
	" \x01(\tR\amessage\"K\n" +
	"\vUserSubject\x12\x19\n" +
	"\bclass_id\x18\x01 \x01(\x05R\aclassId\x12!\n" +
	"\fsubject_name\x18\x02 \x01(\tR\vsubjectName\"\xdc\x02\n" +
	"\x04User\x12\x17\n" +
	"\auser_id\x18\n" +
	" \x01(\x03R\x06userId\x12\x12\n" +
	"\x04name\x18\v \x01(\tR\x04name\x12\x18\n" +
	...
	"\x04role\x18\x0f \x01(\tR\x04role\x12\x1e\n" +
	"\balbum_nr\x18\x11 \x01(\x03H\x00R\aalbumNr\x88\x01\x01\x12/\n" +
	"\x11teaching_staff_id\x18\x12 \x01(\x03H\x01R\x0fteachingStaffId\x88\x01\x01\x12;\n" +
	"\x17administrative_staff_id\x18\x13 \x01(\x03H\x02R\x15administrativeStaffId\x88\x01\x01B\v\n" +
	"\t_album_nrB\x14\n" +
	"\x12_teaching_staff_idB\x1a\n" +
	"\x18_administrative_staff_id\"\x11\n" +
...
var file_auth_proto_depIdxs = []int32{
	...
	18, // 1: modules.common.api.GetUsersResponse.users:type_name -> modules.common.api.User
...
func file_auth_proto_init() {
	...
	file_auth_proto_msgTypes[29].OneofWrappers = []any{}
	type x struct{}
