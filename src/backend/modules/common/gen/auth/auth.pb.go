...
type RegisterRequest struct {
	...
	EmailAppPassword    string                 `protobuf:"bytes,25,opt,name=email_app_password,json=emailAppPassword,proto3" json:"email_app_password,omitempty"` // optional: per-user mail app password (encrypted at rest)
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *RegisterRequest) GetEmailAppPassword() string {
	if x != nil {
		return x.EmailAppPassword
	}
	return ""
}
...
const file_auth_proto_rawDesc = "" +
	...
	"\amessage\x18\v \x01(\tR\amessage\"\xd2\x03\n" +
	...
	"\n" +
	"admin_role\x18\x18 \x01(\tR\tadminRole\x12,\n" +
	"\x12email_app_password\x18\x19 \x01(\tR\x10emailAppPassword\"\x9a\x01\n" +
