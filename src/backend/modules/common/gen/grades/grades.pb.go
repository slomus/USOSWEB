...
const file_grades_proto_rawDesc = "" +
	...
	"\amessage\x18\v \x01(\tR\amessage2\xc0\x01\n" +
	"\rGradesService\x12X\n" +
	"\n" +
	...
	"\bAddGrade\x12\x17.grades.AddGradeRequest\x1a\x18.grades.AddGradeResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/api/gradesBAZ?github.com/slomus/USOSWEB/src/backend/modules/common/gen/gradesb\x06proto3"
...
var file_grades_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_grades_proto_depIdxs = []int32{
	...
	1, // 2: grades.GradesService.ListGrades:input_type -> grades.ListGradesRequest
	3, // 3: grades.GradesService.AddGrade:input_type -> grades.AddGradeRequest
	2, // 4: grades.GradesService.ListGrades:output_type -> grades.ListGradesResponse
	4, // 5: grades.GradesService.AddGrade:output_type -> grades.AddGradeResponse
