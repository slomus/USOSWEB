...
const (
	...
	CourseService_GetMarks_FullMethodName             = "/course.CourseService/GetMarks"
)
...
type CourseServiceClient interface {
	...
	GetMarks(ctx context.Context, in *GetMarksRequest, opts ...grpc.CallOption) (*GetMarksResponse, error)
}
...
func (c *courseServiceClient) GetMarks(ctx context.Context, in *GetMarksRequest, opts ...grpc.CallOption) (*GetMarksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMarksResponse)
	err := c.cc.Invoke(ctx, CourseService_GetMarks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CourseServiceServer interface {
	...
	// Pobiera oceny studenta
	GetMarks(context.Context, *GetMarksRequest) (*GetMarksResponse, error)
...
func (UnimplementedCourseServiceServer) GetMarks(context.Context, *GetMarksRequest) (*GetMarksResponse, error) {
...
func _CourseService_GetMarks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMarksRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CourseServiceServer).GetMarks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CourseService_GetMarks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourseServiceServer).GetMarks(ctx, req.(*GetMarksRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CourseService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMarks",
			Handler:    _CourseService_GetMarks_Handler,
		},
	},
