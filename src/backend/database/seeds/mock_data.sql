-- =====================================================
-- POPRAWIONE MOCK DATA SCRIPT - dostosowane do schematu użytkownika
-- =====================================================

-- Wyczyść istniejące dane (w bezpiecznej kolejności)
TRUNCATE TABLE 
    module_subjects,
    course_subjects, 
    student_classes,
...
-- =====================================================
-- 5. STUDENTS (studenci) - POPRAWIONE IDs
-- =====================================================
...
-- =====================================================
-- 6. TEACHING_STAFF (kadra nauczająca) - POPRAWIONE IDs
-- =====================================================
...
-- =====================================================
-- 12. MESSAGE_RECIPIENTS (odbiorcy wiadomości) - POPRAWIONE IDs
-- =====================================================
...
-- =====================================================
-- 14. APPLICATIONS (podania studentów) - POPRAWIONE album_nr
-- =====================================================
...
-- =====================================================
-- 16. COURSE_INSTRUCTORS (prowadzący zajęcia) - POPRAWIONE IDs
-- =====================================================
...
-- =====================================================
-- 17. STUDENT_CLASSES (studenci na zajęciach) - POPRAWIONE album_nr
-- =====================================================
...
-- =====================================================
-- 18. COURSE_SUBJECTS (przedmioty w kierunkach)
-- =====================================================
...
-- =====================================================
-- 19. MODULE_SUBJECTS (przedmioty w modułach)
-- =====================================================
