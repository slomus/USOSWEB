...
export default function TopBar() {
  ...
  return (
    <>
      <header className="bg-[#202120] text-white px-6 py-3 flex items-center justify-between shadow-md">
        {/* Lewa sekcja: logo + wyszukiwarka */}
        ...
        {/* Prawa sekcja: powitanie + logout + avatar + toggle */}
        <div className="flex items-center gap-4">
      ...
      {/* Nawigacja wyświetlana warunkowo pod TopBarem */}
