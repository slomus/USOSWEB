    ...
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]">
      ...
      <div className="bg-[var(--color-bg-secondary)] border-b border-[var(--color-accent)] px-6 py-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-4 text-sm text-[var(--color-text-secondary)]"></div>
        </div>
      </div>
          ...
          <div className="bg-[var(--color-bg-secondary)] rounded-lg p-6 border border-[var(--color-accent)]">
            ...
            <p className="text-3xl font-bold">
              {semesterData.length > 0
                ? (
                    semesterData.reduce((sum, sem) => sum + sem.average, 0) /
                    semesterData.length
                  ).toFixed(2)
                : "0.00"}
            </p>
                        ...
                        <table className="w-full">
                          <thead>
                            <tr className="border-b border-[var(--color-accent)]">
                              ...
                              <th className="text-center py-3 pl-4 font-semibold">
                                Data
                              </th>
                            </tr>
                          </thead>
