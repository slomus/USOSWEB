...
// --- KOLORY (Spójne z Dashboard) ---
const eventTypeColors: Record<string, { bg: string; border: string }> = {
  holiday: { bg: "#dc2626", border: "#991b1b" },       // Czerwony
  break: { bg: "#f59e0b", border: "#b45309" },         // Pomarańczowy/Bursztynowy
  exam_session: { bg: "#7c3aed", border: "#5b21b6" },  // Fioletowy
  rector_day: { bg: "#db2777", border: "#be185d" },    // Różowy
  semester_start: { bg: "#16a34a", border: "#15803d" },// Zielony
  semester_end: { bg: "#0891b2", border: "#0e7490" },  // Niebieski morski
  registration: { bg: "#2563eb", border: "#1e40af" },  // Niebieski
  deadline: { bg: "#ca8a04", border: "#854d0e" },      // Złoty
  other: { bg: "#4b5563", border: "#374151" },         // Szary
...
export default function CalendarPage() {
  ...
  // Pobieranie wydarzeń akademickich
    ...
    try {
      ...
      if (result.success && Array.isArray(result.events)) {
        ...
        const formattedEvents = academicList.map((item) => {
          ...
          // Logika dat z Dashboardu
          const startDateObj = new Date(item.startDate);
          // Ustawiamy godzinę na 00:00, aby uniknąć przesunięć stref czasowych
          ...
          // FullCalendar wymaga daty końcowej "exclusive" (wyłącznej) dla wydarzeń całodniowych.
          // Np. wydarzenie 1-dniowe (10 maja): start=10 maja, end=11 maja.
          ...
          return {
            ...
            title: item.title,
            start: item.startDate, // String YYYY-MM-DD
            end: fcEndObj.toISOString().split('T')[0], // String YYYY-MM-DD
            allDay: true,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-[var(--color-text-secondary)] mt-1">
              Wydarzenia, święta i harmonogram roku akademickiego.
            </p>
          </div>
        ...
        <div className="bg-[var(--color-bg-secondary)] p-6 rounded-xl shadow-md calendar-wrapper border border-[var(--color-accent)]/20">
          <FullCalendar
            ...
            height="auto"
            contentHeight="auto"
            dayMaxEvents={true} // "Show more" link gdy za dużo
            eventDisplay="block"
          />
        </div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 text-sm">
              <div className="p-3 rounded border text-white font-medium mb-3 flex justify-center text-center" style={{ backgroundColor: selectedEvent.backgroundColor, borderColor: selectedEvent.borderColor }}>
              ...
              <div className="flex items-center gap-3">
                ...
                <span>
                    ...
                    {/* Logika wyświetlania daty końcowej w modalu - odejmujemy 1 dzień, bo FC dodał go dla logiki kalendarza */}
                    {selectedEvent.end && (() => {
                        ...
                        // Wyświetl koniec tylko jeśli jest inny niż start
              ...
              {selectedEvent.extendedProps.academicYear && (
                <div className="flex items-center gap-3">
                    <span className="w-24 text-[var(--color-text-secondary)] font-semibold">Rok akad.:</span>
              ...
              {selectedEvent.extendedProps.appliesTo && (
                <div className="flex items-center gap-3">
                    <span className="w-24 text-[var(--color-text-secondary)] font-semibold">Dotyczy:</span>
